...
- [superpowers](https://github.com/obra/superpowers) - An agentic skills framework & software development methodology that works. ⭐269,343 `Shell` 🔥
...
- [hermes-agent](https://github.com/NousResearch/hermes-agent) - The agent that grows with you ⭐227,553 `Python` 🔥
- [skills](https://github.com/mattpocock/skills) - Skills for Real Engineers. Straight from my .agents directory. ⭐210,096 `Shell` 🔥
...
- [firecrawl](https://github.com/firecrawl/firecrawl) - The context API to search, scrape, and interact with the web at scale. 🔥 ⭐163,454 `TypeScript` 🔥
...
- [ComfyUI](https://github.com/Comfy-Org/ComfyUI) - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface. ⭐124,929 `Python` 🔥
...
- [ponytail](https://github.com/DietrichGebert/ponytail) - Makes your AI agent think like the laziest senior dev in the room. The best code is the code you never wrote. ⭐98,827 `JavaScript` 🔥
...
- [VibeVoice](https://github.com/microsoft/VibeVoice) - Open-Source Frontier Voice AI ⭐52,239 `Python` 🔥
...
- [ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) - An AI SKILL that provide design intelligence for building professional UI/UX multiple platforms ⭐114,766 `Python` 🔥
...
- [Qwen-Agent](https://github.com/QwenLM/Qwen-Agent) - Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc. ⭐16,938 `Python`
...
- [ladybird](https://github.com/LadybirdBrowser/ladybird) - Truly independent web browser ⭐65,010 `C++` 🔥
...
- [codex](https://github.com/openai/codex) - Lightweight coding agent that runs in your terminal ⭐104,817 `Rust` 🔥
...
- [OpenCut](https://github.com/OpenCut-app/OpenCut) - The open-source CapCut alternative ⭐81,725 `TypeScript` 🔥
...
- [cline](https://github.com/cline/cline) - Autonomous coding agent as an SDK, IDE extension, or CLI assistant. ⭐65,896 `TypeScript` 🔥
...
- [CodeWhale](https://github.com/Hmbown/CodeWhale) - Open-source, community-driven agent harness ⭐40,569 `Rust` 🔥
